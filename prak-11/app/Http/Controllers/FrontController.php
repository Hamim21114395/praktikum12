...
class FrontController extends Controller
{
    ...
    {
        // Mengambil data post dengan category 'slider' dari database
        $slider = Post::where('category', 'slider')->first();

        // Mengambil data post dengan category 'about' dari database
        $about = Post::where('category', 'about')->first();

        // Mengambil data post dengan category 'skill' dari database
        $skill = Post::where('category', 'skill')->get();
